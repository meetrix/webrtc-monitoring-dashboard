...
const ResetLinkExpirationMessage = () => {
  ...
  return (
    ...
    //         <div className={classes.paragraphText1}>
    ...
    //       <p className={classes.paragraphText2}>
    //         <strong>Need help?</strong> Contact our
    //       </p>
    //       <button className={classes.forgotButton}>
    //         <a href="mailto:support@screenapp.io" className={classes.anchor}>
    //           <p className={classes.paragraphText3}>support team</p>
    //         </a>
    //       </button>
    //     </div>
    //     </div>
          ...
          <div className={classes.cardsWrapper}>
            ...
            >
              ...
              <div className={classes.alert}>
                ...
                <a
                  href="mailto:support@screenapp.io"
...
export default ResetLinkExpirationMessage;
